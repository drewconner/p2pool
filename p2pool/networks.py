...
#     ),
    worldcoin=math.Object(
        ...
        PERSIST=False,
        WORKER_PORT=9422,
        BOOTSTRAP_ADDRS='wdc.cryptopool.co wdc.bitvolcano.com'.split(' '),
        ANNOUNCE_CHANNEL='#cryptopool',
        VERSION_CHECK=lambda v: True,
    ),
    # worldcoin=math.Object(
    ...
    feathercoin=math.Object(     
        ...
        PERSIST=False,
        WORKER_PORT=9423,
        BOOTSTRAP_ADDRS='pool.maeh.org pool2.maeh.org ftc.cryptopool.co'.split(' '),
        ANNOUNCE_CHANNEL='#cryptopool',
        VERSION_CHECK=lambda v: True,
    ),
    ...
    dogecoin=math.Object(
        ...
        PERSIST=False,
        WORKER_PORT=9424,
        BOOTSTRAP_ADDRS='doge.dtdns.net pool.hostv.pl rav3n.dtdns.net p2pool.org doge.cryptopool.co'.split(' '),
        ANNOUNCE_CHANNEL='#cryptopool',
        VERSION_CHECK=lambda v: True,
    ),
)
