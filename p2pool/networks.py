...
nets = dict(
    ...
    feathercoin=math.Object(     
        ...
        PERSIST=False,
        WORKER_PORT=9423,
        BOOTSTRAP_ADDRS='ftc.coinpuddle.com pool.maeh.org pool2.maeh.org'.split(' '),
        ANNOUNCE_CHANNEL='#coinpuddle',
        VERSION_CHECK=lambda v: True,
    ),
